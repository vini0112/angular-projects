...
describe('ShirtsComponent', () => {
  ...
  it("Should get the products", () =>{
    ...
    // ARRANGE
    const items = [
      {id: 1, name: 'vina', price: 1, isFavorite: true, image: 'jklhjka', section: 'shirts', info: 'jk', sexo: 'masc', isBestseller: true, quantity: 4},
      {id: 2, name: 'klkk', price: 49, isFavorite: true, image: 'jkla', section: 'shirts', info: 'jk', sexo: 'masc', isBestseller: true, quantity: 43}
    ]
    ...
    component.allShirts$.subscribe(res =>{
      expect(res).toEqual(items)
    })
  ...
  it("Should handle error when fails getting the products", () =>{
    ...
    expect(console.log).toHaveBeenCalledWith('ERROR getting shirts: ', erroMSG)
