...
//     const items = [
//       {id: 1, name: 'vina', price: 1, isFavorite: true, image: 'jklhjka', section: 'shoes', info: 'jk', sexo: 'masc', isBestseller: true, quantity: 4},
//       {id: 2, name: 'klkk', price: 49, isFavorite: true, image: 'jkla', section: 'shoes', info: 'jk', sexo: 'masc', isBestseller: true, quantity: 43}
//     ]
...
//     component.allShoes$.subscribe(product => {
//       result = product
//     })
...
//       // ASSERT
//       let result: any[] = [];
//       component.allShoes$.subscribe(favorites => {
//         result = favorites;
//       });
  
//       tick()
  
//       expect(console.log).toHaveBeenCalledWith('ERROR getting shoes-masc: ', resErro)
//       expect(result).toEqual([])
